  ...
  return (
    <main className="h-screen flex items-center justify-center px-4">
      <div className="max-w-[450px] flex flex-col gap-6">
        ...
        <p className="leading-relaxed text-inc-300 text-center">
          Crie uma sala pública de AMA (Ask me anything) e priorize as pergunta mais importantes para a comunidade.
        </p>
